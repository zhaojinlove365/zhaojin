        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input name="name" value="${stockIncomeBill.sn}" class="ui_input_txt02"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input name="depot.id" value="${stockIncomeBill.depot.name}" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">业务时间</td>
                    <td class="ui_text_lt">
                        <input name="client.id" value="<fmt:formatDate value="${stockIncomeBill.vdate}" pattern="yyyy-MM-dd"/>" class="ui_input_txt02"/>
                    </td>
                </tr>
                            ...
                            <c:if test="${empty stockIncomeBill}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="stockIncomeBill.items[0].product.id" tag="pid" value="items.product.id"/>
                                    </td>
                                    <td><span tag="brand">${product.brandName}</span></td>
                                    <td><input tag="costPrice" name="stockIncomeBill[0].items.costPrice" value="items.costPrice"
                                               class="ui_input_txt01"/></td>
                                    <td><input tag="number" name="stockIncomeBill[0].items.number" value="items.number"
                                               class="ui_input_txt01"/></td>
                                    <td><span tag="amount">${item.amount}</span></td>
                                    <td><input tag="remark" name="stockIncomeBill[0].items.remark" value="items.remark"
