        ...
        <div id="top_op">
            <ul>
                ...
                <li>
                    ...
                    <span style="color:yellow;"><span id="h"></span> : <span id="m"></span> : <span id="s"></span></span>
                </li>
            </ul>
        </div>
        <div id="top_close">
    ...
    <div id="left_menu_cnt">
        ...
        <div id="nav_resource">
            <ul id="dleft_tab1" class="ztree">
                <%--<a href="/employee/list.do" target="right">员工列表</a><br/>
                <a href="/department/list.do" target="right">部门列表</a><br/>
                <a href="/role/list.do" target="right">角色列表</a><br/>
                <a href="/permission/list.do" target="right">权限列表</a><br/>--%>
