...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            }).on("blur","[tag=salePrice],[tag=number]",function(){ //给采购价格和采购数量文本框绑定失去焦点事件，去计算金额小计
                var currentTr=$(this).closest("tr");//找到放大镜所在行
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <select name="client.id" class="ui_select03" id="clientSelect">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input type="text" name="vdate" class="ui_input_txt02" value="<fmt:formatDate value="${stockOutcomeBill.vdate}" pattern="yyyy-MM-dd"/>"/>
                    </td>
                </tr>
                <script type="text/javascript">
                    //选中仓库
                        ...
                        <table class="edit_table" cellspacing="0" cellpadding="0" border="0" style="width: auto">
                            ...
                            <tr>
                                ...
                                <td><input tag="number" name="items[0].number"
                                           class="ui_input_txt01"/></td>
                                <td><span tag="amount">${item[0].amount}</span></td>
