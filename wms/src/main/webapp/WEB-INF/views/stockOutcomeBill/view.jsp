        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input name="name" value="${stockOutcomeBill.sn}" class="ui_input_txt02"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input name="depot.id" value="${stockOutcomeBill.depot.name}" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">客户</td>
                    <td class="ui_text_lt">
                        <input name="client.id" value="${stockOutcomeBill.client.name}" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">业务时间</td>
                    <td class="ui_text_lt">
                        <input name="client.id" value="<fmt:formatDate value="${stockOutcomeBill.vdate}" pattern="yyyy-MM-dd"/>" class="ui_input_txt02"/>
                    </td>
                </tr>
                            ...
                            <c:if test="${empty stockOutcomeBill}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="stockOutcomeBill.items[0].product.id" tag="pid" value="items.product.id"/>
                                    </td>
                                    <td><span tag="brand">${product.brandName}</span></td>
                                    <td><input tag="salePrice" name="stockOutcomeBill[0].items.salePrice" value="items.salePrice"
                                               class="ui_input_txt01"/></td>
                                    <td><input tag="number" name="stockOutcomeBill[0].items.number" value="items.number"
                                               class="ui_input_txt01"/></td>
                                    <td><span tag="amount">${item.amount}</span></td>
                                    <td><input tag="remark" name="stockOutcomeBill[0].items.remark" value="items.remark"
