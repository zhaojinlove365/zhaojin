            ...
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/stockOutcomeBill/input.do?id=${item.id}&depotId=${depot.id}">编辑</a>
                            <a href="javascript:;" data-url="/stockOutcomeBill/delete.do?id=${item.id}" class="btn_delete">删除</a>
                            <a href="javascript:;" data-url="/stockOutcomeBill/audit.do?id=${item.id}" class="btn_audit">审核</a>
                        </td>
                        </c:if>
                        <td>
