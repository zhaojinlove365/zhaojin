        ...
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_bottom">
                        <input type="button" value="新增" class="ui_input_btn01 btn_redirect" data-url="/depot/input.do"/>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:;" data-url="/depot/delete.do?id=${item.id}" class="btn_delete">删除</a>
                        </td>
                    </tr>
                    </c:forEach>
                    </tbody>
