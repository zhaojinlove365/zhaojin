...
<body>
<form namespace="/" action="/client/saveOrUpdate.do" method="post" id="editForm" theme="simple">
	<div id="container">
		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input name="sn" class="ui_input_txt02" value="${client.sn}"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt" width="140">联系方式</td>
					<td class="ui_text_lt">
						<input name="phone" class="ui_input_txt02" value="${client.phone}"/>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
