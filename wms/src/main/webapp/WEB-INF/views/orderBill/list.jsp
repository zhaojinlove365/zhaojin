        ...
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_bottom">
                        <input type="button" value="新增" class="ui_input_btn01 btn_redirect" data-url="/orderBill/input.do"/>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/orderBill/input.do?id=${item.id}&supplierId=${supplier.id}">编辑</a>
                            <a href="javascript:;" data-url="/orderBill/delete.do?id=${item.id}" class="btn_delete">删除</a>
                            <a href="javascript:;" data-url="/orderBill/audit.do?id=${item.id}" class="btn_audit">审核</a>
                        </td>
                        </c:if>
                        <td>
