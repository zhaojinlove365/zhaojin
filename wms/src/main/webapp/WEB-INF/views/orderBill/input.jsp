        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <select name="supplier.id" class="ui_select03" id="supplierSelect">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input type="text" name="vdate" class="ui_input_txt02" value="<fmt:formatDate value="${orderBill.vdate}" pattern="yyyy-MM-dd"/>"/>
                    </td>
                </tr>
                <script type="text/javascript">
                    //选中供应商
